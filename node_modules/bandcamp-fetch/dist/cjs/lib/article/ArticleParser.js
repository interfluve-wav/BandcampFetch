    ...
    static parseArticle(html, opts) {
        ...
        if (genreLink.length > 0) {
            ...
            if (genreReadMoreLink) {
                article.genre.readMoreUrl = (0, Parse_js_1.isAbsoluteUrl)(genreReadMoreLink) ? genreReadMoreLink : (0, Parse_js_1.normalizeUrl)(genreReadMoreLink, Constants_js_1.URLS.DAILY);
            }
        }
        // Get category url
        const categoryLink = $('article-type a')?.attr('href');
        if (categoryLink) {
            article.category.url = (0, Parse_js_1.isAbsoluteUrl)(categoryLink) ? categoryLink : (0, Parse_js_1.normalizeUrl)(categoryLink, Constants_js_1.URLS.DAILY);
        }
        ...
        const _getSectionByPlayer = (player) => {
            ...
            if (heading.length > 0) {
                section.heading = {
                    html: heading.html(),
                    text: (0, Parse_js_1.stripTags)((0, Parse_js_1.brToNewLine)(heading.html())).trim()
                };
            }
            // Get html and text
