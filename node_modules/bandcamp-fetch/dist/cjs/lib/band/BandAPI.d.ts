...
export default class BandAPI extends BaseAPIWithImageSupport {
    getDiscography(params: BandAPIGetDiscographyParams): Promise<Array<Album | Track>>;
    getInfo(params: BandAPIGetInfoParams): Promise<Artist | Label>;
    getLabelArtists(params: BandAPIGetLabelArtistsParams): Promise<LabelArtist[]>;
    /**
     * @internal
     */
...
export declare class LimiterBandAPI extends BandAPI {
    ...
    getDiscography(params: BandAPIGetDiscographyParams): Promise<(Album | Track)[]>;
    getInfo(params: BandAPIGetInfoParams): Promise<Artist | Label>;
    getLabelArtists(params: BandAPIGetLabelArtistsParams): Promise<LabelArtist[]>;
}
