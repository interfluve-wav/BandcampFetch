...
const ImageParser_js_1 = __importDefault(require("./ImageParser.js"));
...
class ImageAPI extends BaseAPI_js_1.default {
    /**
     * @internal
     */
    async getConstants() {
        return this.cache.getOrSet(Cache_js_1.CacheDataType.Constants, 'imageConstants', async () => {
            const html = await this.fetch(Constants_js_1.URLS.SITE_URL);
            return ImageParser_js_1.default.parseImageConstants(html);
        });
    }
